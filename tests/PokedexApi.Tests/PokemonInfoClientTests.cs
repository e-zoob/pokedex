...
public class PokemonInfoClientTests
{
    ...
    [Fact]
    public async Task GetPokemonInfoAsync_When500_ThrowsHttpRequestException()
    {
        // Arrange
        var pokemonName = "pikachu";
    ...
    [Fact]
    public async Task GetPokemonInfoAsync_WhenTimeout_ThrowsTaskCanceledException()
    {
        // Arrange
        var pokemonName = "slowpoke";
    ...
    [Fact]
    public async Task GetPokemonInfoAsync_WithNullResponse_ReturnsNull()
    {
        // Arrange
